...
export const GAMES = [
	...
	{n:11,ico:'🧮',name:'Sumas',         sub:'¡Suma frutitas!',       col:'#6BCB77'},
	{n:12,ico:'✏️',name:'Traza Letras',  sub:'Conecta los puntos',    col:'#A78BFA'},
	{n:13,ico:'🗣️',name:'¿Qué Oyes?',   sub:'Escucha y toca',        col:'#F472B6'},
	{n:14,ico:'🧭',name:'Laberinto',     sub:'Ayuda a Pingu',         col:'#2DD4BF'},
	{n:15,ico:'📏',name:'Grande/Pequeño',sub:'¿Cuál es más grande?',  col:'#FF9F43'},
	{n:16,ico:'🔷',name:'Patrones',      sub:'¿Qué sigue después?',   col:'#A78BFA'},
	{n:17,ico:'🎈',name:'Globos',        sub:'¡Revienta los globos!',  col:'#F472B6'},
	{n:18,ico:'🐾',name:'Animales',      sub:'¿Qué animal es?',        col:'#FF9F43'},
	// — Lenguaje —
	{n:19,ico:'👏',name:'Sílabas',       sub:'Cuenta las palmadas',   col:'#FF6B6B',isNew:true},
	{n:20,ico:'🎤',name:'Rimas',         sub:'¿Cuál rima?',           col:'#4D9FEC',isNew:true},
	{n:21,ico:'🔤',name:'Deletrear',     sub:'Ordena las letras',     col:'#6BCB77',isNew:true},
	{n:22,ico:'↔️',name:'Opuestos',      sub:'Encuentra el contrario',col:'#FF9F43',isNew:true},
	...
	{n:31,ico:'🔗',name:'Secuencias',    sub:'¿Qué número falta?',    col:'#4D9FEC',isNew:true},
	{n:32,ico:'📦',name:'Categorías',    sub:'Agrupa por tipo',       col:'#6BCB77',isNew:true},
	{n:33,ico:'#️⃣',name:'Sudoku Mini',   sub:'Completa la cuadrícula',col:'#FF9F43',isNew:true},
	// — Creatividad/Habilidad —
	{n:34,ico:'🥁',name:'Ritmo',         sub:'¡Sigue el ritmo!',      col:'#F472B6',isNew:true},
	{n:35,ico:'✏️',name:'Conecta Puntos',sub:'Une los puntos',        col:'#2DD4BF',isNew:true},
	{n:36,ico:'🪞',name:'Espejo',        sub:'Copia el dibujo',       col:'#A78BFA',isNew:true},
	{n:37,ico:'🫧',name:'Burbujas',      sub:'¡Toca el color!',       col:'#4D9FEC',isNew:true},
