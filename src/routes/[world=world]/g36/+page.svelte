<script>
	...
	function initG36(cont, lv) {
		...
		function next() {
			...
			cont.querySelector('#g36pb').style.width = (round/total*100)+'%';
			...
			// model grid
			const model = cont.querySelector('#g36model'); model.innerHTML = '';
			...
			// player grid
			const player = cont.querySelector('#g36player'); player.innerHTML = '';
